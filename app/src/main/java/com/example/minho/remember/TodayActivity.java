...
public class TodayActivity extends ActionBarActivity implements SwipeRefreshLayout.OnRefreshListener{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        newAdapter = new RecyclerAdapter(getApplicationContext(), items, R.layout.todayactivity);
